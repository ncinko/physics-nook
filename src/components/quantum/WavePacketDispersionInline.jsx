...
export default function WavePacketDispersionInline() {
  ...
  return (
    <section className="not-prose my-8 overflow-hidden rounded-[1.8rem] border border-[var(--grid-line)] bg-[color:var(--sim-bg)] bg-[image:radial-gradient(circle_at_top_right,color-mix(in_srgb,var(--accent-red)_8%,transparent),transparent_34%)] text-[color:var(--text-primary)] shadow-sm">
