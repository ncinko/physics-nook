...
export default function BitErasureThermalCostCalculator() {
  ...
  return (
    <div className="flex h-full min-h-[42rem] w-full flex-col overflow-hidden bg-[color:var(--sim-bg)] bg-[image:radial-gradient(circle_at_top_left,color-mix(in_srgb,#ea580c_12%,transparent),transparent_34%),radial-gradient(circle_at_bottom_right,color-mix(in_srgb,var(--accent-blue)_10%,transparent),transparent_32%)] text-[color:var(--text-primary)]">
