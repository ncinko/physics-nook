...
- Navigation: white/light surface by default, compact brand text, `Interactives` primary link, `Explore` menu, circular theme toggle, and icon-only mobile menu.
...
- For visual changes, smoke-test `/`, `/interactives`, `/math/vectors`, and `/oscillations` at desktop and mobile widths.
