...
export default function WavePacketMeasurementInline() {
  ...
  return (
    <div className="my-8 overflow-hidden rounded-[2rem] border border-[var(--grid-line)] bg-[color:var(--sim-bg)] bg-[image:radial-gradient(circle_at_top_left,color-mix(in_srgb,var(--accent-blue)_12%,transparent),transparent_32%),radial-gradient(circle_at_bottom_right,color-mix(in_srgb,var(--accent-red)_8%,transparent),transparent_34%)] text-[color:var(--text-primary)] shadow-[0_22px_60px_rgba(15,23,42,0.12)]">
