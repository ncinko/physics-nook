...
// The map the landscape is cut from. The lesson's reference view is centred at
// 35.23725, 139.0583 (https://en-us.topographic-map.com/map-4q49nh/Hakone/);
// this window is widened south and west of it so the whole of Lake Ashi fits,
// and re-centred to keep the caldera in the middle of the frame. The lake's own
// bounds, flood-filled off the surveyed surface at 724.5 m, are latitude
// 35.1891 to 35.2398 and longitude 138.9838 to 139.0304, which the window
// clears by roughly 250 m on both the south and west sides.
const CENTRE_LAT = 35.2280, CENTRE_LON = 139.0443;
const HALF_EAST = 5750, HALF_NORTH = 4600;  // metres from the centre
const COLUMNS = 241, ROWS = 193;            // 48 m per grid cell
...
// and Komagatake cone complex, the whole of Lake Ashi and the Hayakawa gorge.
